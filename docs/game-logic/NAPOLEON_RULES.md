...
1. 切り札ではないないスートで全員が同じスートかつ2が出されている場合は2を出したカードの勝利 -> セイム2と呼ぶ
2. セイム2は一番最初の手順では無効
3. セイム2より裏Jの方が強い
4. マイティーが出されたフェーズでハートのQが出た場合はハートのQの勝利（よろめき）
5. よろめきでも切り札か裏Jが出ている場合はそのJが勝利
6. 同じフェーズで切り札Jと対応する最弱Jが出た場合は最弱Jの勝利（スペードとハート・クラブとダイヤ）→狩りJ
7. 狩Jが発動しても別スートの切り札か裏Jも存在している場合は通常通りJの勝利、また、マイティーも出ている場合はマイティーの勝利

-- ============================================
-- 🔒 Supabase Security Advisor Warnings 修正スクリプト
-- ============================================
-- 実行日: 2026-01-09
-- 目的: Security Advisorで検出された4つの警告を修正
--       - public.game_results
--       - public.game_rooms
--       - public.games
--       - public.players
...
-- 古い危険なポリシーを削除
DROP POLICY IF EXISTS "Anyone can create results for INSERT" ON game_results;
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ ========================================';
  RAISE NOTICE '✅ RLSセキュリティ警告の修正が完了しました';
  RAISE NOTICE '✅ ========================================';
  RAISE NOTICE '';
  RAISE NOTICE '修正内容:';
  RAISE NOTICE '  1. game_results - Service Roleのみ作成可、参加者のみ閲覧可';
  RAISE NOTICE '  2. game_rooms - waiting状態は全員閲覧可、管理はホストのみ';
  RAISE NOTICE '  3. games - 参加しているゲームのみアクセス可能';
  RAISE NOTICE '  4. players - 自分のデータのみアクセス可能';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  3. アプリケーションの動作確認を実施';
  RAISE NOTICE '';
END $$;
